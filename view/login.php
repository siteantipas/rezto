...
<html>
<head>
    <title><?php print APP_NAME ?> :: Login to your account </title>
    <meta charset="utf-8">
                         ...
                         <div class="card ">
                          <div class="card-header">
                            ...
                            <ul class="nav nav-tabs card-header-tabs">
                              <li class="nav-item">
                                <a class="nav-link active" href="<?php print ROOT ?>login">Login</a>
                              </li>
                              <li class="nav-item">
                          ...
                          <div class="card-body">
                             ...
                             <form action="<?php print ROOT ?>controller/form-submit.php" method="post" class="container">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input class="form-control" type="text" name="usernameoremail" id="email-or-username" required autocomplete="off" autofocus minlength="5">
                                 </div>
                                 <div class="form-group">
                                     <label for="password">Your awesome password</label>
                                 ...
                                 <div class="form-group"> 
                                     ...
                                     <p class="text-success"><?php print @$_GET['msg'] ?></p>
                                     <button class="btn btn-primary btn-l btn-block bg-primary">Get in</button>
                                 </div> 
                             </form>
                          </div> 
                          <center>
